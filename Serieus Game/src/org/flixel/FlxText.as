package org.flixel
{
	...
	public class FlxText extends FlxSprite
	{
		...
		public function FlxText(X:Number, Y:Number, Width:uint, Text:String=null, EmbeddedFont:Boolean=true)
		{
			...
			var format:TextFormat = new TextFormat("system",12,0xffffff);
		 ...
		 */
		public function setFormat(Font:String=null,Size:Number=12,Color:uint=0xffffff,Alignment:String=null,ShadowColor:uint=0):FlxText
		{
			if(Font == null)
				Font = "";
